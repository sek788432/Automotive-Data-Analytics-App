...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    private boolean dispatchOnItemTouchIntercept(MotionEvent e2) {
        ...
        while (i < listenerCount) {
            ...
            if (!listener.onInterceptTouchEvent(this, e2) || action == 3) {
                i++;
            } else {
    ...
    private boolean dispatchOnItemTouch(MotionEvent e2) {
        int action = e2.getAction();
        if (this.mActiveOnItemTouchListener != null) {
            if (action == 0) {
                this.mActiveOnItemTouchListener = null;
            } else {
                this.mActiveOnItemTouchListener.onTouchEvent(this, e2);
        ...
        if (action != 0) {
            ...
            for (int i = 0; i < listenerCount; i++) {
                OnItemTouchListener listener = this.mOnItemTouchListeners.get(i);
                if (listener.onInterceptTouchEvent(this, e2)) {
                    this.mActiveOnItemTouchListener = listener;
                    return true;
                }
            }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e2) {
        ...
        if (dispatchOnItemTouchIntercept(e2)) {
            cancelTouch();
            return true;
        } else if (this.mLayout == null) {
            return false;
            ...
            this.mVelocityTracker.addMovement(e2);
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    int index = e2.findPointerIndex(this.mScrollPointerId);
                    if (index >= 0) {
                        int x2 = (int) (e2.getX(index) + 0.5f);
                        int y2 = (int) (e2.getY(index) + 0.5f);
                ...
                case 3:
                    ...
                    break;
                case 5:
                    this.mScrollPointerId = e2.getPointerId(actionIndex);
    ...
    private void onPointerUp(MotionEvent e2) {
        ...
        if (e2.getPointerId(actionIndex) == this.mScrollPointerId) {
            ...
            this.mScrollPointerId = e2.getPointerId(newIndex);
            int x = (int) (e2.getX(newIndex) + 0.5f);
            this.mLastTouchX = x;
            this.mInitialTouchX = x;
            int y = (int) (e2.getY(newIndex) + 0.5f);
            this.mLastTouchY = y;
            this.mInitialTouchY = y;
        }
    }
