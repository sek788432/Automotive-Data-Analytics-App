...
abstract class MapCollections<K, V> {
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object o) {
            if (!this.mEntryValid) {
                ...
                if (!ContainerHelpers.equal(e2.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0)) || !ContainerHelpers.equal(e2.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1))) {
                    return false;
                }
                return true;
            }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            Map.Entry<?, ?> e2 = (Map.Entry) o;
            int index = MapCollections.this.colIndexOfKey(e2.getKey());
            if (index < 0) {
                return false;
            }
            return ContainerHelpers.equal(MapCollections.this.colGetEntry(index, 1), e2.getValue());
        }
