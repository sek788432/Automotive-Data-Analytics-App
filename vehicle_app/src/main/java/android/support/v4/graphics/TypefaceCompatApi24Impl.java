...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry entry, Resources resources, int style) {
        Object family = newFamily();
        for (FontResourcesParserCompat.FontFileResourceEntry e2 : entry.getEntries()) {
            ByteBuffer buffer = TypefaceCompatUtil.copyToDirectBuffer(context, resources, e2.getResourceId());
            if (buffer == null || !addFontWeightStyle(family, buffer, e2.getTtcIndex(), e2.getWeight(), e2.isItalic())) {
                return null;
            }
        }
